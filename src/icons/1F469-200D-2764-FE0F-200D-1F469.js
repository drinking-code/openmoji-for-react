...
const CoupleWithHeart:Woman,Woman = (size) => {
    if (!size) size = '1.2em';
    return (
  ...
  <g id="line">
    ...
    <path fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" d="M12,46.6"/>
...
export default CoupleWithHeart:Woman,Woman;
