...
const WomanAndManHoldingHands:MediumDarkSkinTone,MediumLightSkinTone = (size) => {
    if (!size) size = '1.2em';
    return (
...
export default WomanAndManHoldingHands:MediumDarkSkinTone,MediumLightSkinTone;
