...
const PersonClimbing:MediumLightSkinTone = (size) => {
    if (!size) size = '1.2em';
    return (
  ...
  <g id="line">
    <path fill="none" stroke="#000000" stroke-miterlimit="10" stroke-width="2" d="M51.9688,12.0938"/>
    <path fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" d="M39,8"/>
...
export default PersonClimbing:MediumLightSkinTone;
