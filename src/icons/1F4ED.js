...
const OpenMailboxWithLoweredFlag = (size) => {
    if (!size) size = '1.2em';
    return (
  ...
  <g id="line">
    <g id="_1F4ED-2">
      ...
      <path fill="#fff" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M39.3,59.4V41.6533l-6.813.0082L32.5,46.4v13"/>
    </g>
  </g>
</svg>
