...
const PersonSurfing:MediumLightSkinTone = (size) => {
    if (!size) size = '1.2em';
    return (
  ...
  <g id="skin-shadow"/>
  <g id="line">
    <path fill="#000000" stroke="none" d="M65.834,63.4443"/>
    ...
    <path fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" d="M29.9834,52.5381"/>
...
export default PersonSurfing:MediumLightSkinTone;
