...
const WomanAndManHoldingHands:MediumLightSkinTone,MediumDarkSkinTone = (size) => {
    if (!size) size = '1.2em';
    return (
...
export default WomanAndManHoldingHands:MediumLightSkinTone,MediumDarkSkinTone;
