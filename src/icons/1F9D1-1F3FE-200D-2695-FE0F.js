...
const HealthWorker:MediumDarkSkinTone = (size) => {
    if (!size) size = '1.2em';
    return (
  ...
  <g id="line">
    ...
    <path fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M46.885,47.8989"/>
...
export default HealthWorker:MediumDarkSkinTone;
