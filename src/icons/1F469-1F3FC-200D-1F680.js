...
const WomanAstronaut:MediumLightSkinTone = (size) => {
    if (!size) size = '1.2em';
    return (
  ...
  <g id="line">
    ...
    <path fill="none" stroke="#000000" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M36.3152,22.4355"/>
...
export default WomanAstronaut:MediumLightSkinTone;
