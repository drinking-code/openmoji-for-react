...
const Flag:Afghanistan = (size) => {
  ...
  <g id="color">
    ...
    <path fill-opacity="0.1216" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.775" d="m32.58 28.68v15.07"/>
    <path fill-opacity="0.1216" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.766" d="m39.4 28.67v14.91"/>
...
export default Flag:Afghanistan;
